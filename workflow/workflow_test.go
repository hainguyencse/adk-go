...
func (m *MockInvocationContext) AppendInputRealtimeCache(agent.RealtimeCacheEntry)  {}
func (m *MockInvocationContext) AppendOutputRealtimeCache(agent.RealtimeCacheEntry) {}
...
func (m *MockInvocationContext) SetLiveSessionResumptionHandle(string)              {}
func (m *MockInvocationContext) ToolResponseCache() agent.ToolResponseCache         { return nil }
func (m *MockInvocationContext) GetCachedToolResponse(context.Context, string) (map[string]any, bool) {
	return nil, false
}
func (m *MockInvocationContext) SetCachedToolResponse(context.Context, string, map[string]any) {}
