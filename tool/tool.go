...
//
// Context is an alias for agent.Context: the unified context type also used
// by the google.golang.org/adk/workflow package's nodes. Aliasing (rather
// than duplicating) the interface lets a tool.Tool constructed via
// google.golang.org/adk/tool/functiontool be invoked directly from a
// workflow.ToolNode.
